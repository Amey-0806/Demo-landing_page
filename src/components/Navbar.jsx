                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center space-x-2">
                        <svg width="155" height="24" viewBox="0 0 155 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M13.3955 0.905882L19.4121 11.189H7.36728L13.3955 0.905882Z" fill="#4CAF4F" />
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-6">
                            <a href="#" className="text-gray-700 hover:text-green-600 text-base font-medium transition duration-150 ease-in-out cursor-pointer">
                                Home
                            </a>
                            <a href="#" className="text-gray-700 hover:text-green-600 text-base font-medium transition duration-150 ease-in-out cursor-pointer">
                                Service
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <button
                            type="button"
                            className="text-green-600 hover:text-green-800 font-semibold transition duration-150 ease-in-out px-3 py-1"
                        >
                            Login
                        </button>
                        <button
                            type="button"
                            className="bg-green-600 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:bg-green-700 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                        >
                            Sign up
                        </button>
                    </div>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-gray-50 border-t border-gray-200">
                    <div className="pt-2 pb-3 space-y-1 px-2 sm:px-3">
                        {/* Hardcoded Mobile Links */}
                        <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100">Home</a>
                        <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100">Service</a>
                        <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100">Feature</a>
                        <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100">Product</a>
                        <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100">Testimonial</a>
                        <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100">FAQ</a>
                    </div>
                    <div className="pt-4 pb-3 border-t border-gray-200 space-y-2 px-4">
                        <button
                            type="button"
                            className="w-full text-center text-green-600 hover:text-green-800 font-semibold px-3 py-2 rounded-md"
                        >
                            Login
                        </button>
                        <button
                            type="button"
                            className="w-full text-center bg-green-600 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:bg-green-700"
                        >
                            Sign up
                        </button>
                    </div>
